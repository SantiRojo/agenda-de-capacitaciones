...
- Modo oscuro/claro: por defecto sigue la preferencia del sistema, pero hay un switch en la esquina superior derecha para forzar uno u otro manualmente. La elección queda guardada en el navegador de cada persona (localStorage), así que cada una puede tener su propia preferencia sin afectar a la otra.
